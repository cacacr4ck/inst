...
echo 
echo "+===============================+" | lolcat
echo "| Nickname : MR.xoexarno        |" | lolcat
echo "| WhatsApp : +6283821362840     |" | lolcat
echo "| Status   : JOMBLO:V           |" | lolcat
echo "+===============================+" | lolcat
echo
toilet -f future "  SANTUYY  " | lolcat
echo   " Silahkan dipilih : " | lolcat
echo "+===========================+" | lolcat
echo "+[1].KUOTA MURAH     |  X  |+" | lolcat
echo "+[2].DDOS            |  O  |+" | lolcat
echo "+[3].AUTO REPORT     |  E  |+" | lolcat
echo "+[4].PROFIL GUARD FB |  X  |+" | lolcat
echo "+[5].BOT IG          |  A  |+" | lolcat
echo "+[6].HACK FB TARGET  |  R  |+" | lolcat
echo "+[7].SPAM WA         |  N  |+" | lolcat
echo "+[8].SPAM SMS        |  O  |+" | lolcat
echo "+[F].DarkFb          |  -  |+" | lolcat
echo "+[H].Mode Hacker     |  -  |+" | lolcat
